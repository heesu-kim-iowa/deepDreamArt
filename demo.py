...
model_path = '/content/drive/My Drive/caffe/models/bvlc_googlenet/' # substitute your path here
...
img = np.float32(PIL.Image.open('/content/drive/My Drive/sky1024px.jpg'))
# showarray(img)
